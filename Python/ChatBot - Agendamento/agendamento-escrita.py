...
def confirmar_agendamento(nome, dia_mes, horario):
    ...
    if confirmacao in ["sim", "s"]:
        ...
        print("Dentina: O endereço de Dra Ortodontista é Rua XXX, nº 123 - Bairro ZZZ - Ribeirão Preto/SP.")
...
def processar_entrada():
    """Processa a entrada do usuário e direciona para a função apropriada com base nas palavras-chave."""
    while True:
        entrada = input("Dentina: Como posso ajudá-lo(a) hoje? ").strip().lower()
        
        if "agendar" in entrada or ("marcar" and "consulta" in entrada) or ("marcar" and "horario" in entrada) or ("perdi" and "horario" in entrada) or ("perdi" and "dia" in entrada) or ("perdi" and "consulta" in entrada) or ("perdi" and "data" in entrada): # tirei o "marcar" sozinho pq estava dando conflito com "desmarcar" abaixo
            nome, dia_mes, horario = obter_informacoes()
            confirmar_agendamento(nome, dia_mes, horario)
        elif "remover" in entrada or "desmarcar" in entrada:
        ...
        elif "recuperar" in entrada or ("pin" and "esqueci" in entrada) or "pin" in entrada or "codigo" in entrada or "perdi" in entrada:
            nome = input("Dentina: Qual é o nome COMPLETO do(a) paciente? ").upper()
        ...
        elif "visualizar" in entrada or "ver" in entrada or "esqueci" in entrada or "lembro" in entrada or "confirme" in entrada or "confirmar" in entrada or "confirma" in entrada or "agendado" in entrada or "agendei" in entrada or "marquei" in entrada or "marcado" in entrada:
            pin = input("Dentina: Por favor, forneça o PIN do seu agendamento: ")
            nome = input("Dentina: Qual é o nome COMPLETO do(a) paciente? ").upper()
            visualizar_agendamento(pin, nome)
        elif "endereco" in entrada or "endereço" in entrada or "chegar" in entrada or "contato" in entrada or "zap" in entrada or "cel" in entrada or "tel" in entrada or "telefone" in entrada or "celular" in entrada or "whatsapp" in entrada or "whats" in entrada or "chega" in entrada or "rua" in entrada or "fica" in entrada or "onde" in entrada or "aonde" in entrada:
            print("Dentina: O endereço de Dra Ortodontista é Rua XXX, nº 123 - Bairro ZZZ - Ribeirão Preto/SP.")
            print("Dentina: Qualquer dúvida entre em contato pelo número (16)1234-1234.")
        elif "sair" in entrada or "fechar" in entrada or "encerrar" in entrada:
            print("Dentina: Até logo! Se precisar alterar seu horário, estarei aqui.")
            break
        else:
            print("Dentina: Não entendi sua solicitação. Por favor, digite uma opção válida.")
